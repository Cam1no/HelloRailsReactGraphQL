...
CREATE TABLE `users` (
  ...
  `first_name` varchar(255) COLLATE utf8mb4_bin NOT NULL COMMENT 'FirstName',
  `last_name` varchar(255) COLLATE utf8mb4_bin NOT NULL COMMENT 'LastName',
  ...
  KEY `index_users_on_gender` (`gender`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
